        ...
        <section
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="space-y-2.5">
              <h1 className="h2-bold text-dark100_light_900">Join Overflow</h1>
              <p className="paragraph-regular text-dark500_light400">To get your questions answered.</p>
            </div>
            <Image src="images/site-logo.svg" width={50} height={50} className="object-contain" alt="Overflow Logo"/>
          </div>
          {children}
